...
//        public async Task<IActionResult> Create([Bind("HotShotId,ProductId,NewPrice,Quantity,ItemsSold,StartDate,DurationInHours,Finished")] HotShot hotShot)
//        {
...
//        [HttpPost]
//        [ValidateAntiForgeryToken]
//        public async Task<IActionResult> Edit(int id, [Bind("HotShotId,ProductId,NewPrice,Quantity,ItemsSold,StartDate,DurationInHours,Finished")] HotShot hotShot)
//        {
